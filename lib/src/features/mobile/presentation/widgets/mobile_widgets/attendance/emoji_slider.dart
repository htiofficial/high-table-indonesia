...
class MyEmojiSlider extends StatefulWidget {
  const MyEmojiSlider({
    Key? key,
  ...
  @override
  State<MyEmojiSlider> createState() => _MyEmojiSliderState();
}

class _MyEmojiSliderState extends State<MyEmojiSlider>
